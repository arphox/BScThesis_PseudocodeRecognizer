...
namespace LexicalAnalysis.Tokens
{
    internal static class TokenListExtensions
    {
        ...
        /// </summary>
        internal static int FindTypeOfIdentifierAtLastPosition(this List<TerminalToken> outputTokens)
        {
        ...
        private static void AdjustLastThreeOutputTokensForArrayType(IList<TerminalToken> outputTokens)
        {
